...
function Avatar({ type, image, setImage }) {
  ...
  const showContextMenu = (e) => {
    ...
    // Logging updated cordinates
    console.log("Context Menu Cordinates:", x, y);
    setContextMenuCordinates({ x, y });
    setIsContextMenuVisible(true);
    console.log("hdff",isContextMenuVisible)
    ...
    <>
      ...
      {isContextMenuVisible && (
        <ContextMenu
          ...
          cordinates={contextMenuCordinates} // Pass cordinates correctly
