 ...
 * @param extendedData 扩展信息
 */
declare type HallStateUpdateCallBack = (state: 'DISCONNECTED' | 'CONNECTING' | 'CONNECTED', errorCode: number, extendedData: string) => void;
/**
 * token将要过期回调
 *
 ...
 * @param extendedData 扩展信息
 */
declare type RoomStateChangedCallBack = (roomID: string, reason: ZegoRoomStateChangedReason, errorCode: number, extendedData: string) => void;
