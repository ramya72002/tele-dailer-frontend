...
import { ZegoVoiceChangerPreset } from "../../src/common/zego.entity";
import { ZegoEvent, ZegoCapabilityDetection, ZegoDeviceInfos, ZegoDeviceInfo, ZegoLocalStreamConfig, ZegoMixStreamAdvance, ZegoMixStreamConfig, ZegoPublishStreamAudioConfig, ZegoPublishStreamConfig, ZegoServerResponse, ZegoWebPlayOption, ZegoWebPublishOption, ZegoCheckSingleType, ZegoElectronScreenSource, ZegoEffectsBeautyParam, ZegoSEIConfig, ZegoPublishStats, ZegoPlayStats, SoundLevelDelegateOptions, ZegoLowlightEnhancementMode, ZegoAutoSwitchDeviceConfig, BackgroundBlurOptions, BackgroundVirtualOptions, Segmentation } from "./ZegoExpressEntity.web";
...
export declare class ZegoExpressEngine extends ZegoExpressWebRTMEngine {
     ...
     *
     * @param filePath 图片路径
     * @param localStream 需要在该流关闭时发送图片的流对象
     */
    setDummyCaptureImagePath(filePath: string, localStream: MediaStream): Promise<boolean>;
    /**
     * 设置流的附加信息
     *
     * Note: 支持版本：1.0.0
     ...
     *
     * @param localStream 创建流获取的摄像头媒体流。
     ...
     */
    setEffectsBeauty(localStream: MediaStream, enable: boolean, options?: ZegoEffectsBeautyParam): Promise<ZegoServerResponse>;
    /**
     * 设置低照度增强。
     *
     * 支持版本：2.18.0 及以上。
     ...
     *
     * @param localStream 媒体流对象。
     * @param mode 低照度增强模式。
     */
    setLowlightEnhancement(localStream: MediaStream, mode: ZegoLowlightEnhancementMode): Promise<ZegoServerResponse>;
    /**
     * 开启大小流
     *
     ...
     * @param localStream 创建流得到的 MediaStream 对象。
     */
    enableDualStream(localStream: MediaStream): void;
    /**
     * 设置小流参数
     *
     * Note: 支持版本：2.18.0 及以上。
     ...
     */
    setLowStreamParameter(localStream: MediaStream, param: {
        width: number;
        height: number;
        frameRate: number;
        bitRate: number;
     ...
     * 1. 目前仅支持 PC 端使用，移动端暂不支持；
     *
     * @param localStream 媒体流。
     * @param options 背景虚化处理的参数。
     */
    setBackgroundBlurOptions(localStream: MediaStream, options: BackgroundBlurOptions): Promise<boolean>;
    /**
     * 设置虚拟背景相关处理参数。
     *
     * 支持版本：2.24.0 及以上版本。
     ...
     */
    setVirtualBackgroundOptions(localStream: MediaStream, options: BackgroundVirtualOptions): Promise<boolean>;
    /**
     * 开启背景处理功能。
     *
     * 支持版本：2.24.0 及以上。
     ...
     */
    enableBackgroundProcess(localStream: MediaStream, enable: boolean, segmentation: Segmentation): Promise<ZegoServerResponse>;
    /**
     * 支持版本：2.23.0
     *
     * 详情描述：将推送的媒体流进行变声处理。
     ...
     * @param preset 变声预设值
     */
    setVoiceChangerPreset(preset: ZegoVoiceChangerPreset, localstream: MediaStream): Promise<ZegoServerResponse>;
    /**
     * 传入媒体流，开启或关闭 AI 降噪
     *
     * 支持版本：2.19.0
     ...
     *
     * @param localStream 需要切换 AI 降噪的媒体流
     * @param enable 开启/关闭 AI 降噪
     */
    enableAiDenoise(localStream: MediaStream, enable: boolean): Promise<ZegoServerResponse>;
    /**
     * 开始拉流
     *
     * Note: 支持版本：1.0.0 及以上。
     ...
     *
     * @param localStream 本地媒体流，通过 createStream 接口获取。
     *
     * @return 媒体流播放器组件实例对象。
     */
     ...
     *
     * @param streamID 需要混音的流 ID 或 MediaStream 对象。
     * @param mediaList 1. 本地的 <audio> 或 <video> 对象数组。
     *                  2. 对音效的操作（包括暂停/恢复）需要通过操作 <audio> 或 <video> 对象来完成。
     */
    startMixingAudio(streamID: string | MediaStream, mediaList: Array<HTMLMediaElement>): boolean;
    /**
     * 停止混音
     *
     * Note: 支持版本：1.7.0 及以上。
     ...
     * @return 音效播放器实例对象。
     */
    createAudioEffectPlayer(localStream: MediaStream): ZegoAudioEffectPlayer;
    /**
     * 加载音效资源。
     *
     * Note: 支持版本：2.15.0 及以上
